...
|--------------------|--------------------------------|
|cohort|Supporters of ideas, plans or people|
|childhood|the state or period of being a child|
|end up|to reach or come to an end, usually unpleasant|
|childhood wheeze|To make a sound resembling laborious breathing|
|available |obtainable or accessible|
|the onset of asthma| The beginning or start of asthma|
|underlying|that can be discovered only by close analysis or examination|
|innate|existing from birth|
|pathways| The route by which a process occurs|
|dishwashing detergents|detergent designed for use in dishwashers|
|laundry detergents|detergents designed for use in a washing machine for clothing|
|polishes|a substance used to give smoothness or gloss|
|plug-in deodorizer|deodorizer designed to be plugged in to an electric circuit|
|dusting spray|spray to wipe the dust from|
|scented|with a distinctive smell, esp a pleasant one|
|takeaway|to pick or choose from a number of alternatives,select|
...
|                                   |                                                                                                                          |
| ----------------------------------| ------------------------------------------------------------------------------------------------------------------------|
|**Researchers**                |Dr. Tim Takaro (professor and clinician- scientist in the Faculty of Health Sciences at Simon Fraser University (SFU)) and Jaclyn Parks (graduate student in the Faculty of Health Sciences at SFU)|
|**Published in, the magazine** |February 18, 2020. Science Daily|
|**General topic**              |The risk of childhood asthma increases with the exposure to cleaning products in first 3 months of life.|
|**Procedure/what was examined**|Infants (2,022) who typically spend 80-90% of their time indoors and are especially vulnerable to chemical exposures. The study examined 26 types of household cleaners.|
|**Conclusions/discovery**      |At three years of age, these children were more likely to have : Recurrent wheeze, recurrent wheeze with atopy and asthma but this study doesn't show an association between a risk of atopy alone and the use of cleaning products. So it's proposed that chemicals in cleaning products damage the cells that line the respiratory tract through innate inflammatory pathways rather than acquired allergic pathways.Also the study show that at the age of three years, the relationship between respiratory problems and product exposure was less stronger in boys than girls.|
|**Remaining questions**        |Are there any differences between male and female biological responses to inflammatory exposures in early life ?|
